        ...
        this.shadowRoot.innerHTML = `
            <style>
                :host {
                    ...
                    width: 100%;
                    max-width: 15rem; /* Prevents buttons from getting too wide */
                }
                button {
                    width: 100%;
                    padding: 1rem 1.5rem;
                ...
                /* Subtle bottom borders to show the theme (Grey, Green, Red) */
            ...
            <button class="theme-${theme}">
                <slot></slot> <!-- This injects the text from your HTML -->
            </button>
        `;
    }

    // This allows app.js to disable the button using btn.disabled = true
    set disabled(val) {
